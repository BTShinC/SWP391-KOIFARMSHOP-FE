  ...
  const handleBuyNow = () => {
        ...
        if (accountBalance >= finalPrice) {
          ...
          message.info(
            <div className="no-money-msg">
              ...
              <Button style={{ marginLeft: "20px" }} onClick={() => navigate("/wallet")}>
                Nạp tiền
              </Button>
            </div>
          );
    ...
    return (
      <div className="single-product">
            ...
            <>
              <div className="image-gallery">
                <div className="thumbnail-container">
                  ...
                  <Image src={product.image1} alt="Thumbnail 2" className="thumbnail" />
                  <Image src={product.image2} alt="Thumbnail 3" className="thumbnail" />
                </div>
        ...
        {cartVisible && <ShoppingCart cartItems={cartItems} onClose={() => setCartVisible(false)} />}
        ...
        <Modal
          ...
          footer={[
            ...
            <Button key="submit" type="primary" loading={buyNowLoading} onClick={handleConfirmBuyNow}>
              Xác nhận đặt hàng
            </Button>,
          ]}
        >
          <div className="order-summary">
            <div style={{ marginBottom: "10px" }}>
              ...
              <span style={{ float: "right" }}>{totalAmount.toLocaleString("vi-VN")} VNĐ</span>
            </div>
            <div style={{ marginBottom: "10px" }}>
              <span>Giảm giá:</span>
              <span style={{ float: "right" }}>{discount.toLocaleString("vi-VN")} VNĐ</span>
            </div>
            <div style={{ marginBottom: "10px" }}>
              <span>Phí vận chuyển:</span>
              <span style={{ float: "right" }}>{deliveryFee.toLocaleString("vi-VN")} VNĐ</span>
            </div>
            <Divider />
            <div>
              <strong>Tổng cộng:</strong>
              <strong style={{ float: "right", color: "#B88E2F" }}>{finalPrice.toLocaleString("vi-VN")} VNĐ</strong>
            </div>
          </div>
        </Modal>
      </div>
