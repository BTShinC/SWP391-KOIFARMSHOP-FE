        ...
        <div>
            <div className="about">
                ...
                <p className="content">
                    ...
                    Với mục tiêu trở thành nhà cung cấp cá Koi hàng đầu tại Việt Nam, Koifish cam kết mang đến không chỉ những chú Koi đẹp, khỏe mạnh, mà còn tạo nên những trải nghiệm đáng nhớ cho khách hàng. Chúng tôi không ngừng đầu tư vào công nghệ và nâng cao chất lượng dịch vụ để đạt đến sự hoàn thiện trong mỗi bước phát triển.<br></br>
                </p>
