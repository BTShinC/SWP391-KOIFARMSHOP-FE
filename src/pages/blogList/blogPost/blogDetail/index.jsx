...
import { Card, CardMedia, CardContent, Typography, Box, Container,Button} from '@mui/material';
...
function BlogDetail() {
  ...
  return (
    ...
    <Container maxWidth="md" sx={{ mt: 4 }}>
      <Card sx={{ boxShadow: 4, borderRadius: 2, height:"80vh" }}>
        <CardMedia
          component="img"
        ...
        <CardContent>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 2 }}>
            <Typography variant="body2" sx={{ color: '#888' }}>
              Tác giả: {postDetail.author}
            </Typography>
            <Typography variant="body2" sx={{ color: '#888' }}>
              Ngày đăng: {postDetail.date}
            </Typography>
          </Box>
        </CardContent>
      </Card>
